...
class Host(models.Model):
    ...
    os_v = models.CharField(verbose_name='操作系统版本', max_length=256, default='', null=False)
    ip = models.GenericIPAddressField(verbose_name='IP地址')
    p_ip = models.GenericIPAddressField(verbose_name='p_IP地址')
    ...
    @classmethod
    def create_or_replace(cls, name, ip, arch, os, mem, cpu,p_ip,os_v):
        obj = None
        try:
            obj = Host.objects.get(p_ip=p_ip)
